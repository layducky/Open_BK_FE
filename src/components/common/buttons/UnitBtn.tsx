  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center p-0.5 mb-2 me-2 text-sm font-medium text-black rounded-lg group bg-linear-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800"
      >
...
function ActionDropdown({ options }: ActionDropdownProps) {
  ...
  return (
    <div className="relative inline-block text-right w-full md:w-40" ref={dropdownRef}>
      <button
      ...
      {isDropdownOpen && (
        <div className="absolute right-0 mt-1 max-h-48 overflow-y-auto min-w-32 w-max bg-white border border-gray-200 rounded shadow-lg z-50">
