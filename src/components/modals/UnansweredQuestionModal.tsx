...
export default function UnansweredQuestionModal({
  onClose,
  onConfirm,
  unansweredCount,
  totalCount,
}: UnansweredQuestionModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="mx-4 w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
        ...
        <p className="mb-6 text-gray-600">
          Bạn còn <strong>{unansweredCount}</strong> câu chưa trả lời trong tổng số <strong>{totalCount}</strong> câu.
